...
public class FavoriteDao {
	...
	public void create(Recipe recipe){
		...
		for (Ingredient ingredient : recipe.getIngredients()) {
			database.execSQL(sqlIngrediente, new String[]{String.valueOf(idIngrediente), ingredient.getNome(), String.valueOf(idReceita)});
			idIngrediente++;
		}
	...
	public List<Recipe> getAll(){
		...
		while(!cursorReceita.isAfterLast()){
			...
			receita.setIngredients(ingredientes);
