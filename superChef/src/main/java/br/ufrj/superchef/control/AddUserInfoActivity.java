...
import br.ufrj.superchef.domain.CookTypeEnum;
import br.ufrj.superchef.domain.DietEnum;
import br.ufrj.superchef.domain.RecipeCousineEnum;

public class AddUserInfoActivity extends br.ufrj.superchef.control.BasicActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (br.ufrj.superchef.domain.CookTypeEnum diet : br.ufrj.superchef.domain.CookTypeEnum.values()) {
        ...
        int indexCookType = br.ufrj.superchef.domain.CookTypeEnum.getByName(cookTypePrefs);
		...
		saveButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.commit();
				Intent intent = new Intent(AddUserInfoActivity.this, br.ufrj.superchef.control.RecomendationRecipesActivity.class);
