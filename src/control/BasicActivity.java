...
import service.NavDrawerListAdapter;
		...
		case R.id.home:
			...
			if (userName != null) {
				...
				if(!conectado(this)){
					...
					Intent intent = new Intent(this, RecomendationRecipesActivity.class);
			...
			return true;
		case R.id.search:
			startActivity(new Intent(this, SearchRecipyActivity.class));
			return true;
//		case R.id.favorite:
			...
			case 0:
				...
				if (userName != null) {
					...
					if(!conectado(context)){
						...
						intent = new Intent(context, RecomendationRecipesActivity.class);
						intent.putExtra("name", userName);
						intent.putExtra("diet", diet);
						intent.putExtra("cookType", cookType);
						intent.putExtra("recipyCousine", recipyCousine);
				...
				break;
			case 1:
				intent = new Intent(context, SearchRecipyActivity.class);
				break;
			case 2:
				intent = new Intent(context, FavoriteActivity.class);
				break;
			case 3:
				intent = new Intent(context, AddUserInfoActivity.class);
				break;
			case 4:
				intent = new Intent(context, ChronometerActivity.class);
				break;
